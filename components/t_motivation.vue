<template>
  <div>
    <v-row>
      <v-col sm12>
        <h2><v-icon medium>mdi-table-network </v-icon>ตารางเหตุผลการจำหน่าย</h2>
        <h3 v-if="btneditandremove" class="red--text">ไอดี: {{ id }}</h3>
